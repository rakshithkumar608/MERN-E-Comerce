...
const AdminSidebar = () => {
  ...
  return (
    <div className='p-6'>
      <div className='mb-6'>
        <Link to="/admin" className='text-2xl font-medium '>Martify
        </Link>
      </div>
      
      <h2 className='text-1xl font-medium mb-6 text-center'>Admin Dashboard</h2>

      <nan className="flex flex-col space-y-2">
